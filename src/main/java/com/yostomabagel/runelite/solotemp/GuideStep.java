	...
	Start(
		...
		@Override public boolean isStepCompleted(SoloTempPlugin context) {
			...
			if (context.getPlayerInv().count() == 1 && context.getPlayerInv().contains(WATERBUCKET_ID))
				return true;
			if (context.getPlayerInv().contains(HARPOONFISHRAW_ID)) {
